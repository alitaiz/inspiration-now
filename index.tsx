...
// This file is a monolithic combination of all project files to work around
// the limitations of in-browser Babel transpilation with ES modules.
// It relies on global React and ReactDOM objects loaded from a CDN.
...
const ExternalLinkIcon: FC<SVGProps<SVGSVGElement>> = (props) => (
    <svg 
...
interface ErrorDisplayProps { message: string; }
...
const QuoteCard: FC<QuoteCardProps> = ({ quote, author, imageUrl }) => {
